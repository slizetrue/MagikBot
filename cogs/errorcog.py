...
class Error(commands.Cog):
    ...
    async def on_command_error(self,ctx: commands.Context,error):
        ...
        if isinstance(error, commands.CommandNotFound):
            embed = discord.Embed(description=":x: │ The command you typed does not exist. Run the command **b!help**, which will give you a list of commands.",colour=discord.Colour.purple())
